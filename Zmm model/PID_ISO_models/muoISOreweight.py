...
nohup python -u muoISOreweight.py --tag 110820_ZbbW  output/PID_ISO_Dataset/110820_ZbbW/110820_ZbbW.h5 2>&1 &> output/logIsoReweight.txt & disown
...
parser.add_argument('--outdir', action='store', default="output/ISOReweightFiles/", type=str,
