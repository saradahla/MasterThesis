...
nohup python -u createZDataDataset.py --tag 160920 ../../hdf5Prod/output/root2hdf5/Data010920/Data010920_0000.h5 ../../hdf5Prod/output/root2hdf5/Data010920/Data010920_0001.h5 ../../hdf5Prod/output/root2hdf5/Data010920/Data010920_0002.h5 ../../hdf5Prod/output/root2hdf5/Data010920/Data010920_0003.h5 2>&1 &> output/logZDataDataset.txt & disown
nohup python -u createZDataDataset.py --tag 170920 ../../hdf5Prod/output/root2hdf5/Data010920/Data010920_0004.h5 ../../hdf5Prod/output/root2hdf5/Data010920/Data010920_0005.h5 ../../hdf5Prod/output/root2hdf5/Data010920/Data010920_0006.h5 ../../hdf5Prod/output/root2hdf5/Data010920/Data010920_0007.h5 ../../hdf5Prod/output/root2hdf5/Data010920/Data010920_0008.h5 ../../hdf5Prod/output/root2hdf5/Data010920/Data010920_0009.h5 2>&1 &> output/logZDataDataset170920.txt & disown
nohup python -u createZDataDataset.py --tag 131020_MC ../../hdf5Prod/output/root2hdf5/Zmm131020/Zmm131020_0004.h5 ../../hdf5Prod/output/root2hdf5/Zmm131020/Zmm131020_0005.h5 ../../hdf5Prod/output/root2hdf5/Zmm131020/Zmm131020_0006.h5 ../../hdf5Prod/output/root2hdf5/Zmm131020/Zmm131020_0007.h5 ../../hdf5Prod/output/root2hdf5/Zmm131020/Zmm131020_0008.h5 ../../hdf5Prod/output/root2hdf5/Zmm131020/Zmm131020_0009.h5 ../../hdf5Prod/output/root2hdf5/bb310820/bb310820_0004.h5 ../../hdf5Prod/output/root2hdf5/bb310820/bb310820_0005.h5 ../../hdf5Prod/output/root2hdf5/bb310820/bb310820_0006.h5 ../../hdf5Prod/output/root2hdf5/bb310820/bb310820_0007.h5 ../../hdf5Prod/output/root2hdf5/bb310820/bb310820_0008.h5 ../../hdf5Prod/output/root2hdf5/bb310820/bb310820_0009.h5 ../../hdf5Prod/output/root2hdf5/Wmn310820/Wmn310820_0004.h5 ../../hdf5Prod/output/root2hdf5/Wmn310820/Wmn310820_0005.h5 ../../hdf5Prod/output/root2hdf5/Wmn310820/Wmn310820_0006.h5 ../../hdf5Prod/output/root2hdf5/Wmn310820/Wmn310820_0007.h5 ../../hdf5Prod/output/root2hdf5/Wmn310820/Wmn310820_0008.h5 ../../hdf5Prod/output/root2hdf5/Wmn310820/Wmn310820_0009.h5 2>&1 &> output/logZDataDataset131020.txt & disown
...
def signalSelection(hf, event, comb, invM, nType, cutZ = 10):
    Z_mass = 91.187 #GeV

    # Charge of the muons?
    muo0_charge = hf["muo_charge"][ event ][ comb[0] ]
    muo1_charge = hf["muo_charge"][ event ][ comb[1] ]


    if ((muo0_charge*muo1_charge) < 0):

        #if ((Z_mass - cutZ) < invM) & ((Z_mass + cutZ) > invM): # Invariant mass in range [80, 100] GeV
            #muoType = 1
        nType[0,0] += 1
        return 1
    ...
    # elif invM > 20: # sameSign and invM > 20 Gev
    #         #muoType = 0
    #     nType[0,2] += 1
    #     return 0

    else: # samesign invM < 20 GeV
        nType[0,1] += 1
        return 0
...
def PlotNtype(histNtype):
    ...
    labels[1] = 'Opposite-sign'
    labels[2] = 'Same-sign'
    #labels[2] = 'Trash: Opposite sign, non mZ'
    #labels[3] = 'Bkg: Same-sign and invM > 20 GeV'
    #labels[4] = 'Trash: Same-sign and invM < 20 GeV'
    #labels[3] = 'Trash: At least one of the muons below 4.5 GeV'
    ax.set_xticklabels(labels)
    ax.set_ylabel("Frequency")

    fig.tight_layout()
    fig.savefig(args.outdir + "NtypeHist" + ".pdf")
...
def MakeFiles(arguments):
    ...
    for i, event in enumerate(np.arange(start,stop)):
        ...
        if (nMuo >= 2):
            ...
            for c in comb:
                if hf[ "muo_pt" ][ event ][ c[0] ]/1000 < 4.5: # cut out muons with pt < 4.5 GeV
                    continue
                if hf[ "muo_pt" ][ event ][ c[1] ]/1000 < 4.5:
                    continue
                #try:
                invM, pt, eta, phi = invMass(hf, event, c)

                selection = signalSelection(hf, event, c, invM, nType)
...
#Plot the types of data
PlotNtype(histNtype_total[0])
