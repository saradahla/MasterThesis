...
nohup python -u cutIsoPt.py --tag 100920_Data  output/MuoSingleHdf5/010920_3/010920_3.h5 2>&1 &> output/logCutIsoPt.txt & disown
...
parser.add_argument('--outdir', action='store', default="output/MuoCutFilesForPID/", type=str,
...
ax[1].axvline(0, color = 'k', linestyle = "dashed", label = "Cut on signal")#, bins = 50, cmax = 30);
...
# Cut on Isolation
#============================================================================
mask_iso = (data["muo_ISO_score"] > 0)
data[data["label"] == 1] = data[(data["label"] == 1) & mask_iso]
